# Cancelamento e reinício final

O cancelamento está disponível desde o rascunho da Nova condição e nas etapas seguintes. O motivo é obrigatório.

- Antes do aceite: cancela processo e etapas abertas, revoga pendências e libera nova migração.
- Após o aceite: exige confirmação reforçada e preserva documento, assinatura e evidências.
