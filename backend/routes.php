...
return static function (Router $router): void {
    ...
    $router->get('/clientes/detalhe/conexao', [ClientController::class, 'connectionDetails'], 'clients.detail.connection');
    $router->get('/clientes/detalhe/financeiro', [ClientController::class, 'financialDetails'], 'clients.detail.financial');
    $router->get('/clientes/documentos/digitalizar', [ClientDocumentController::class, 'scanner'], 'clients.documents.scanner');
    $router->post('/clientes/documentos/digitalizar', [ClientDocumentController::class, 'scanner'], 'clients.documents.scanner.store');
    $router->get('/clientes/documentos/arquivo', [ClientDocumentController::class, 'download'], 'clients.documents.download');
    ...
    $router->get('/processos/migracao', [OperationalProcessController::class, 'migration'], 'processes.migration');
